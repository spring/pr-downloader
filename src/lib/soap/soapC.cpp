...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.3 2012-03-16 01:45:11 GMT")
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_xsd__base64Binary:
		...
		break;
	case SOAP_TYPE___Plasma__DownloadFile:
		soap_serialize___Plasma__DownloadFile(soap, (const struct __Plasma__DownloadFile *)ptr);
		break;
	case SOAP_TYPE_PointerTo_Plasma__DownloadFileResponse:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE___Plasma__DownloadFile:
		return (void*)soap_instantiate___Plasma__DownloadFile(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE_Plasma__ArrayOfString:
		if (p->size < 0)
			SOAP_DELETE((Plasma__ArrayOfString*)p->ptr);
		else
			SOAP_DELETE_ARRAY((Plasma__ArrayOfString*)p->ptr);
		break;
	case SOAP_TYPE__Plasma__DownloadFile:
		if (p->size < 0)
			SOAP_DELETE((_Plasma__DownloadFile*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_Plasma__DownloadFile*)p->ptr);
		break;
	case SOAP_TYPE__Plasma__DownloadFileResponse:
		if (p->size < 0)
			SOAP_DELETE((_Plasma__DownloadFileResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_Plasma__DownloadFileResponse*)p->ptr);
		break;
	case SOAP_TYPE___Plasma__DownloadFile:
		if (p->size < 0)
			SOAP_DELETE((struct __Plasma__DownloadFile*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __Plasma__DownloadFile*)p->ptr);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_Plasma__ResourceType(struct soap *soap, const enum Plasma__ResourceType *a, const char *tag, const char *type)
{
	...
	if (soap_out_Plasma__ResourceType(soap, tag?tag:"Plasma:ResourceType", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 _Plasma__DownloadFileResponse * SOAP_FMAC4 soap_in__Plasma__DownloadFileResponse(struct soap *soap, const char *tag, _Plasma__DownloadFileResponse *a, const char *type)
{
	...
	size_t soap_flag_torrent1 = 1;
	size_t soap_flag_dependencies1 = 1;
	size_t soap_flag_resourceType1 = 1;
	size_t soap_flag_torrentFileName1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
...
int _Plasma__DownloadFileResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"Plasma:DownloadFileResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _Plasma__DownloadFileResponse * SOAP_FMAC2 soap_instantiate__Plasma__DownloadFileResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_Plasma__DownloadFileResponse);
		if (size)
			*size = sizeof(_Plasma__DownloadFileResponse);
		((_Plasma__DownloadFileResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_Plasma__DownloadFileResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 _Plasma__DownloadFile * SOAP_FMAC4 soap_in__Plasma__DownloadFile(struct soap *soap, const char *tag, _Plasma__DownloadFile *a, const char *type)
{
	...
	size_t soap_flag_internalName1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
...
int _Plasma__DownloadFile::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"Plasma:DownloadFile", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _Plasma__DownloadFile * SOAP_FMAC2 soap_instantiate__Plasma__DownloadFile(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_Plasma__DownloadFile);
		if (size)
			*size = sizeof(_Plasma__DownloadFile);
		((_Plasma__DownloadFile*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_Plasma__DownloadFile[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int Plasma__ArrayOfString::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"Plasma:ArrayOfString", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 Plasma__ArrayOfString * SOAP_FMAC2 soap_instantiate_Plasma__ArrayOfString(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(Plasma__ArrayOfString);
		if (size)
			*size = sizeof(Plasma__ArrayOfString);
		((Plasma__ArrayOfString*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(Plasma__ArrayOfString[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___Plasma__DownloadFile(struct soap *soap, struct __Plasma__DownloadFile *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->Plasma__DownloadFile = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___Plasma__DownloadFile(struct soap *soap, const struct __Plasma__DownloadFile *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
...
SOAP_FMAC3 struct __Plasma__DownloadFile * SOAP_FMAC4 soap_in___Plasma__DownloadFile(struct soap *soap, const char *tag, struct __Plasma__DownloadFile *a, const char *type)
{
	...
	short soap_flag;
	a = (struct __Plasma__DownloadFile *)soap_id_enter(soap, "", a, SOAP_TYPE___Plasma__DownloadFile, sizeof(struct __Plasma__DownloadFile), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___Plasma__DownloadFile(soap, a);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___Plasma__DownloadFile(struct soap *soap, const struct __Plasma__DownloadFile *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___Plasma__DownloadFile(soap, tag?tag:"-Plasma:DownloadFile", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __Plasma__DownloadFile * SOAP_FMAC4 soap_get___Plasma__DownloadFile(struct soap *soap, struct __Plasma__DownloadFile *p, const char *tag, const char *type)
{
	if ((p = soap_in___Plasma__DownloadFile(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __Plasma__DownloadFile * SOAP_FMAC2 soap_instantiate___Plasma__DownloadFile(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___Plasma__DownloadFile(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___Plasma__DownloadFile, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __Plasma__DownloadFile);
		if (size)
			*size = sizeof(struct __Plasma__DownloadFile);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __Plasma__DownloadFile[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct __Plasma__DownloadFile);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
...
SOAP_FMAC3 void SOAP_FMAC4 soap_copy___Plasma__DownloadFile(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	...
	*(struct __Plasma__DownloadFile*)p = *(struct __Plasma__DownloadFile*)q;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_Plasma__DownloadFileResponse(struct soap *soap, _Plasma__DownloadFileResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_Plasma__DownloadFileResponse(soap, tag?tag:"Plasma:DownloadFileResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_Plasma__DownloadFile(struct soap *soap, _Plasma__DownloadFile *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_Plasma__DownloadFile(soap, tag?tag:"Plasma:DownloadFile", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerToPlasma__ArrayOfString(struct soap *soap, Plasma__ArrayOfString *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerToPlasma__ArrayOfString(soap, tag?tag:"Plasma:ArrayOfString", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
