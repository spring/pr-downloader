...
#ifndef soapPlasmaServiceSoapProxy_H
#define soapPlasmaServiceSoapProxy_H
#include "soapH.h"

class SOAP_CMAC PlasmaServiceSoapProxy : public soap
{ public:
	/// Endpoint URL of service 'PlasmaServiceSoapProxy' (change as needed)
	const char *soap_endpoint;
	/// Constructor
	PlasmaServiceSoapProxy();
	/// Constructor with engine input+output mode control
	PlasmaServiceSoapProxy(soap_mode iomode);
	/// Constructor with engine input and output mode control
	PlasmaServiceSoapProxy(soap_mode imode, soap_mode omode);
	/// Destructor frees deserialized data
	virtual	~PlasmaServiceSoapProxy();
	/// Initializer used by constructor
	virtual	void PlasmaServiceSoapProxy_init(soap_mode imode, soap_mode omode);
